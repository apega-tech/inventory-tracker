...
🔗 **Live Demo:** [inventory-tracker demo](https://apega-tech.github.io/inventory-tracker/) — a client-side version (localStorage instead of Flask/SQLite) so it can run free on GitHub Pages
...
reorder logic, and flagging issues before they become stockouts. Rebuilding
...
- Deploy to Render/Railway for a live, clickable demo
